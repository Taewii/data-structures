...
//    p02_enterprice.Employee getByUUID(UUID id);
    @Test
    ...
    //Iterable<p02_enterprice.Employee> searchByNameAndPosition(String firstName, String lastName, p02_enterprice.Position position);
    ...
    //    Iterable<p02_enterprice.Employee> allWithPositionAndMinSalary(p02_enterprice.Position position, double minSalary);
